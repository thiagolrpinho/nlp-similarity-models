''' Module created by: Sang-Kil Park
    Available at: https://github.com/likejazz/Siamese-LSTM/
'''
import re
...
def make_w2v_embeddings(df, embedding_dim=300, empty_w2v=False):
    ...
    if empty_w2v:
        ...
        word2vec = KeyedVectors.load_word2vec_format('/home/dev/gensim-data/word2vec-google-news-300/word2vec-google-news-300.gz', binary=True)
